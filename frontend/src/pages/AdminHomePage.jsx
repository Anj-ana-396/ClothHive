        ...
        <div className="max-w-7xl mx-auto p-6">
            ...
            {productsLoading || ordersLoading ? (<p>Loading...</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="p-4 shadow-lg rounded-lg  border-gray-300 border-2">
                    ...
                    <div className="p-4 shadow-lg rounded-lg  border-gray-300 border-2">
                        ...
                        <Link
                            to="/admin/orders"
                            className=" text-teal-600 hover:text-gray-400 hover:underline">
                            Manage Orders
                        </Link>
                    </div>
                            ...
                            {orders.length > 0 ? (
                                orders.map((order) => (
                                    <tr
                                        ...
                                        <td className="p-4 font-bold text-topbar">{order._id}</td>
